(function ($) {
        ...
        var Branch = function (p, v, r, c, t,ispc) {
        ...
        Branch.prototype = {
            ...
            modify: function () {
                ...
                var angle = 0.2 - (0.1 / this.generation);
                ...
                if (this.r < 0.4 || this.generation > 30) {
            ...
            fork: function () {
                ...
                var p = this.ispc == true?this.length - Branch.random(300, 300):this.length - Branch.random(90, 90); // + (this.generation * 10);
               
                
                if (p > 0) {
                    //树枝密度

                    var n = this.ispc == true?Math.round(Branch.random(0, 10, 0)) : Math.round(Branch.random(1, 2, 3));
        ...
        function init() {
            ...
            //远
            var stretch_factor = ispc? 300 / canvas_height : 400 / canvas_height;

            var y_speed = ispc? 0.9 / stretch_factor : 1.2 / stretch_factor;
            ...
            if(ispc){
             for (var i = 0; i < 12; i++) {
                 new Branch(new Vector(center_x, canvas_height), new Vector(Math.random(10), -y_speed), 15 / stretch_factor, Branch.randomrgba(0, 255, 0.3), t);
                }
            }else{
                for (var i = 0; i < 6; i++) {
                new Branch(new Vector(center_x, canvas_height), new Vector(Math.random(-1,6), -y_speed), 12 / stretch_factor, Branch.randomrgba(0, 255, 0.3), t);
                } 
            }
            t.render(function () {
